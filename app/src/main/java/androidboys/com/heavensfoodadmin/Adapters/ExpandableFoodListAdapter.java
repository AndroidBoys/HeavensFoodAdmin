...
public class ExpandableFoodListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, ArrayList<Food>> _listDataChild;

    public ExpandableFoodListAdapter(Context context, ArrayList<String> listDataHeader,
...
//        });
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        //to expand all the groups initially
